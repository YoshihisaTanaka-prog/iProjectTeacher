...
//! \~english
//! Close the connection to the signaling server. In addition, the connected mediaConnection and dataConnection are continued.
//! \~
//!
//!
//! \code{.m}
...
//! \~japanese シグナリングサーバへ再接続します。再接続の際には割り当て済みのPeer IDを使用します。
//! \~english Reconnect to the signaling server. Use the assigned Peer ID when reconnecting.
//! \~
//!
//! \code{.m}
//! SKWPeer* peer;
